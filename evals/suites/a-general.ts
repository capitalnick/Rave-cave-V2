...
export const sectionA: EvalTestCase[] = [
  // A1. Basic Wine Knowledge
  {
    ...
    judgeCriteria: 'Accurate varietal comparison. Mentions body, tannins, fruit profile differences. No cellar references. French flourishes present. Informative but not overly academic.',
  },
  {
