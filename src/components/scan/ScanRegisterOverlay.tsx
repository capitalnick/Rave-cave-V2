...
import type { Wine, ScanStage, WineDraft, ExtractionResult, DuplicateCandidate, CommitStage, ExtractionErrorCode, WineBriefContext } from '@/types';
...
import type { ScanAction } from '@/hooks/useScanReducer';
