  ...
  return (
    <div className="flex h-screen bg-[var(--rc-surface-tertiary)] text-[var(--rc-ink-primary)] overflow-hidden">
      ...
      <main
        ...
        className="flex-1 relative overflow-hidden flex flex-col bg-[var(--rc-surface-tertiary)] pb-[calc(4rem+env(safe-area-inset-bottom))] md:pb-0 transition-[padding-right] duration-200"
