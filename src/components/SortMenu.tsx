          ...
          <div className="py-1 px-1">
            ...
            {decisionOptions.map(opt => (
              <button
                ...
                className="flex items-center justify-between w-full px-3 py-2 text-left text-sm font-[var(--rc-font-body)] hover:bg-[var(--rc-surface-sunken)] rounded-[var(--rc-radius-sm)] transition-colors"
                style={{ color: opt.value === value ? 'var(--rc-accent-pink)' : 'var(--rc-ink-primary)' }}
              >
                <span>{opt.label}</span>
